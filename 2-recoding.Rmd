...
state == 25 ~ "21. Dadra and Nagar Haveli and Daman and Diu",  # (replaces Daman & Diu)
state == 12 ~ "22. Arunachal Pradesh",
state == 11 ~ "23. Sikkim",
state == 36 ~ "24. Telangana",
state == 35 ~ "25. Andaman and Nicobar Islands",
state == 30 ~ "26. Goa",
state == 3  ~ "27. Punjab",
state == 2  ~ "28. Himachal Pradesh",
state == 16 ~ "29. Tripura",
state == 31 ~ "30. Lakshadweep",
state == 1  ~ "31. Jammu and Kashmir",
state == 4  ~ "32. Chandigarh",
state == 32 ~ "33. Kerala",
state == 13 ~ "34. Nagaland",
state == 14 ~ "35. Manipur",
state == 15 ~ "36. Mizoram"
))
